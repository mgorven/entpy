...
from .ent_pass_then_deny_models import EntPassThenDenyGen, EntPassThenDenyModel
from .ent_pass_then_deny_models import EntPassThenDenyAPIModel  # noqa: F401


privacy_logger = logging.getLogger("entpy.privacy")


class EntPassThenDeny(EntPassThenDenyGen):
    @classmethod
