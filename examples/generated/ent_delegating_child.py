...
from .ent_delegating_child_models import EntDelegatingChildGen, EntDelegatingChildModel
from .ent_delegating_child_models import EntDelegatingChildAPIModel  # noqa: F401


privacy_logger = logging.getLogger("entpy.privacy")


class EntDelegatingChild(EntDelegatingChildGen):
    @classmethod
